    ...
    return (
        <div>
            ...
            <div className='text-center p-5 sm:text-lg md:text-xl'>
                <p> <a href='https://github.com/kduperis/veazitFront' target={'_blank'} className="text-green-800 sm:text-slate-800 md:sm:text-red-800 lg:text-purple-800 underline hover:opacity-80">➡️&thinsp;&thinsp;Click here to find the front-end repository</a></p>
                <p> <a href='https://github.com/kduperis/veazitBackend' target={'_blank'} className="text-green-800 sm:text-slate-800 md:text-red-800 lg:text-purple-800 underline hover:opacity-80">➡️&thinsp;&thinsp;Click here to find the back-end repository</a></p>
            </div>
